...
- (NSString *) cityName { return @"Amiens"; };
- (NSString*) serviceName { return @"Vélam"; }
@end
...
- (NSString *) cityName { return @"Besançon"; };
- (NSString*) serviceName { return @"VéloCité"; }
@end
...
- (NSString *) cityName { return @"Brisbane"; };
- (NSString*) serviceName { return @"CityCycle"; }
@end
...
- (NSString *) cityName { return @"Bruxelles"; };
- (NSString*) serviceName { return @"Villo!"; }
@end
...
- (NSString *) cityName { return @"Cergy-Pontoise"; };
- (NSString*) serviceName { return @"VélO2"; }
...
- (NSString *) cityName { return @"Créteil"; };
- (NSString*) serviceName { return @"CristoLib"; }
@end
...
- (NSString *) cityName { return @"Dublin"; };
- (NSString*) serviceName { return @"dublinbikes"; }
@end
...
- (NSString *) cityName { return @"Göteborg"; };
- (NSString*) serviceName { return @"Styr & Ställ"; }
@end
...
- (NSString *) cityName { return @"Ljubljana"; };
- (NSString*) serviceName { return @"Bicike(LJ)"; }
@end
...
- (NSString *) cityName { return @"Luxembourg"; };
- (NSString*) serviceName { return @"vel’oh"; }
@end
...
- (NSString *) cityName { return @"Mulhouse"; };
- (NSString*) serviceName { return @"Vélocité"; }
@end
...
- (NSString *) cityName { return @"Nancy"; };
- (NSString*) serviceName { return @"Vélostan"; }
@end
...
- (NSString *) cityName { return @"Nantes"; };
- (NSString*) serviceName { return @"Bicloo"; }
@end
...
- (NSString *) cityName { return @"Rouen"; };
- (NSString*) serviceName { return @"Cy’clic"; }
@end
...
- (NSString *) cityName { return @"Santander"; };
- (NSString*) serviceName { return @"TusBic"; }
@end
...
- (NSString *) cityName { return @"Sevilla"; };
- (NSString*) serviceName { return @"SEVici"; }
@end
...
- (NSString *) cityName { return @"Toulouse"; };
- (NSString*) serviceName { return @"VélÔ"; }
@end
...
- (NSString *) cityName { return @"Toyama"; };
- (NSString*) serviceName { return @"CyclOcity"; }
@end
...
- (NSString *) cityName { return @"Valencia"; };
- (NSString*) serviceName { return @"Valenbisi"; }
@end
