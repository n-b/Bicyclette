...
//	CGColorRef otherColor = [UIColor colorWithHue:0.02f saturation:1.f brightness:.56f alpha:1.f].CGColor;
    ...
    CGRect spotRect;
    spotRect.size.width = spotRect.size.height = (rect.size.width-1)  / nbCols;
    if(nbRows<nbCols)
        CGContextTranslateCTM(ctxt, 0, lroundf(spotRect.size.height/2));
...
//    }
	...
	// -
//	if( 0 && self.station.status_date && !self.station.loading)
//	{
